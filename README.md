...
- **Dashboard executivo:** [`dashboard_superstore.html`](./dashboard_superstore.html) — painel interativo (Artifact), construído com o Claude a partir de um resumo executivo ([`resumo_executivo.md`](./resumo_executivo.md)) sintetizado do notebook completo — não passou por revisão de um Gem
